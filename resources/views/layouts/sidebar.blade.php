        ...
        <ul class="space-y-2">
            ...
            <li>
                <div class="relative dropdown">
                    ...
                    <!-- Dropdown Menu -->
                    <div id="groups-dropdown" class="dropdown-menu absolute left-0 top-full mt-1 w-48 bg-gray-800 rounded-lg shadow-lg p-2 hidden z-50">
            ...
            <li>
                <a href="{{ route('projects') }}" 
                   class="sidebar-link {{ request()->is('projects*') ? 'active' : '' }}">
                    <svg class="icon-md" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <li>
                <a href="{{ route('messages') }}" 
                   class="sidebar-link {{ request()->is('messages*') ? 'active' : '' }}">
                    <svg class="icon-md" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"/>
                    </svg>
                    @if(request()->cookie('sidebar_open') != 'false')
